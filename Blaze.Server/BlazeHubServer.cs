...
{
    internal static class BlazeHubServer
    {
        private static readonly Socket _socket;

        private static long _clientID;

        private static readonly Dictionary<long, Client> Clients;
        ...
        private static void AcceptCallback(IAsyncResult ar)
        {
            ...
            try
            {
                ...
                client.Stream.BeginAuthenticateAsServer(Certificate.BlazeHubServer, AuthenticateAsServerCallback,
                    client.ID);
            }
            catch (Exception ex)
            {
