...
{
    internal static class PostAuthCommand
    {
        public static void HandleRequest(Request request)
        {
            Log.Info($"Client {request.Client.ID} post-authenticating");
            ...
            var data = new List<Tdf>
            {
                ...
                new TdfStruct("TICK", new List<Tdf>
                {
                    ...
                    new TdfString("SKEY",
                        $"{request.Client.User.ID},127.0.0.1:8999,battlefield-3-pc,10,50,50,50,50,0,12")
                }),
