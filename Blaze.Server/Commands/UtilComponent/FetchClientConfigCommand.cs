...
{
    internal static class FetchClientConfigCommand
    {
        public static void HandleRequest(Request request)
        {
            Log.Info($"Client {request.Client.ID} requested client configuration");
